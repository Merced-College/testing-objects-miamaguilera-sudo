...
public class ObjectTester {
    ...
    public static void main (String[] args) {
        ...
        //test of data varbles as public
        Dog dog2 = new Dog();
        ...
        //test the contructors for the defult and non-default - dv still public
        ...
        //step 10
        System.out.println("\nMutating fields via setters after making fields private:");
        d3.setAge(5);
        d3.setName("Max");
        ...
        System.out.println("\nMutating via setters again after making fields private:");
        d3.setAge(6);
        d3.setName("Maxwell");
